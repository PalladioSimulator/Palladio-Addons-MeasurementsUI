...
public interface ResourceEditor {
    ...
    /**
     * Sets MetricDescription for a MeasurementSpecification. A List of all Metric Descriptions can
     * be gotten through: aMSpec.getMetricDescription().getRepository().getMetricDescriptions()
     * 
    ...
    /**
     * Adds a new MeasurementSpecification to the list of MeasurementSpecifications for the monitor
     * 
     * @param monitor
