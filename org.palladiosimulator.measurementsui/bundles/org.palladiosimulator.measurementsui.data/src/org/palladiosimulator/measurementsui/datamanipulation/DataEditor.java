...
public class DataEditor {
    ...
    /**
     * Changes the EObject element's attribute to the new Value. Implementation is done in
    ...
    /**
     * Command for adding a resource to an element, like a list(measurementspecifications)
     * 
     * @param element
     * @param attribute
     * @param newValue
