...
/**
 * The DataEditor class provides the basic functions for working with Resources
 * that already have an editing domain, meaning they can only be modified
 * through EMF Commands. These methods are further implemented in {@link ResourceEditor}
 * 
...
public class DataEditor {
	...
	/**
	 * Changes the EObject element's attribute to the new value using a SetCommand. Old value is overwritten.
	 * 
	 * @author Florian
	 * @param element
	 * @param attribute
	...
	/**
	 * Command for appending a resource to an element, like a
	 * list(measurementspecifications) using the AddCommand
	 * 
	 * @param element
	 * @param attribute
	 * @param newValue
