...
public class ProcessingTypeProvider {
	...
	/**
	 * The five Processing types the wizard will support. Sadly PCM does not provide
	 * a class containing all Processing Types, meaning new Processing Types would
	 * need to be added manually.
	 * 
	 * @return a String Array containing the names of all supported Processing
	 *         Types. Needed in this format for drop-down in 4th page.
	 */
	 ...
	 * 
	 * @param processingTypeString The PT to provide the properties for.
	...
	/**
	 * Sets the PT to the selected Measurement Specification. TODO: EMF Commands for
	 * Edit Mode.
	 * 
	...
	/**
	 * returns the value of a selected PT attribute of a selected Measurement
	 * Specification.
	 * 
	 * @param measurementSpecification
	 * @param processingTypeProperty
