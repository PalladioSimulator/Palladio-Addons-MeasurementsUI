 ...
 * 
 * @TODO: adapt moveMetricSpecificationBetweenMonitors to work with an array of
 *        selected Metric Descriptions, to allow moving multiple selected
 * @author Florian
 *
 */
public class UnselectedMetricSpecificationsProvider {
	...
	/**
	 * Creates a Monitor with all of the Metric Description <-> Measurement
	 * Specification pairs that do not already exist in the passedMonitor needed for
	 * the left half of the 3rd Wizard Page
	 * 
	 * @param passedMonitor The Monitor that gets passed from the previous Wizard
	 *                      Page
	 * @return the Monitor with the missing Metric Description<->Measurement
	 *         Specification pairs
	 */
	...
	/**
	 * Creates a Monitor with all MetricDesc<->MeasurementSpec pairs for every
	 * MetricDesc from the listOfMetricDescriptions
	 * 
	 * @param monFactory
	 ...
	 * Needed for implementation of Left/Right Buttons in Wizard Page 3
	 * 
	 ...
	 * the double Arrow (move All) in the 3rd Wizard Page
	 * 
	 * @param sendingMonitor
	 * @param receivingMonitor
	 */
