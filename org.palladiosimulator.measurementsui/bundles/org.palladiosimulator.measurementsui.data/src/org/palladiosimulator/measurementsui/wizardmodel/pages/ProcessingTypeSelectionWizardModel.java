...
public class ProcessingTypeSelectionWizardModel implements WizardModel {
	...
	/**
	 * 
	 * @param monitor   the monitor containing the selected
	 *                  MeasurementSpecifications from Page 3
	 * @param isEditing Boolean containing information if we are in edit mode or not
	 */
	...
	/**
	 * Provides all possible Processing Types in a String Array, used to fill the
	 * dropdown in the 4th page.
	 * 
	...
	/**
	 * Returns a list of String for the modification fields of the corresponding
	 * Processing Type. Used for the 3rd and 4th columns in the 4th page.
	 * 
