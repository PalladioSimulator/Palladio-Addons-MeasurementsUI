...
public abstract class MpComponentViewer {
     ...
     * @param application
     */
    protected MpComponentViewer(Composite parent, MDirtyable dirty, ECommandService commandService,
     ...
     *            of a respository which should be shown in the TreeView
     */
    protected abstract void initParsley(Composite parent);

    /**
     * Disposes of the operating system resources associated with the tree and all its descendants
     */
     ...
     * 
     * @param resource
     *            which will be shown in the updated tree
     */
     ...
     * 
     * @param injector
     *            Google Juice injector of the parsley project
     ...
     * @param editingDomain
     *            editingdomain of the treeview
     * @param injector
     *            Google guice injector of the parsley project
