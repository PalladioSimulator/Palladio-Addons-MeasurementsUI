...
/**
 * 
 * @author David Schütz Generates a tree view where all monitors from a selected monitorrepository
 *         in the workspace are shown. Creates a connection between the parsley mpview view and an
 *         eclipse e4 plugin.
 */
